/**
 * SCÈNE 2 — PREUVE desktop (capsule horizontale).
 * Mobile : pile verticale dans le Hero (HeroProofLinks) — pas de carrousel ici.
 */
...
export function ProofStripSection() {
  return (
    <section
      className="relative z-10 citadelle-proof-section hidden md:block"
      aria-label="Preuve — surfaces Citadelle"
    >
      <div className="pt-8 lg:pt-10 pb-2">
