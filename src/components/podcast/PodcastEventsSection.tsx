  ...
  return (
    <section className="mb-12 md:mb-16 px-4 md:px-0" aria-label="En ce moment à la Citadelle">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-5">
        ...
        <Link
          href={hrefOf(main)}
          className="group lg:col-span-2 relative rounded-2xl overflow-hidden border border-white/10 hover:border-gold/30 bg-white/[0.02] transition-colors flex flex-col"
        >
        ...
        <div className="flex flex-col gap-4 md:gap-5">
          {secondary.map((e) => (
            <Link
              key={e.id}
              href={hrefOf(e)}
              className="group relative rounded-2xl overflow-hidden border border-white/10 hover:border-gold/30 bg-white/[0.02] transition-colors flex sm:flex-row lg:flex-col"
            >
              <div className="relative w-32 sm:w-40 lg:w-full flex-shrink-0 aspect-square lg:aspect-[16/9] overflow-hidden bg-white/[0.03]">
                {e.cover_url ? (
                  <Image
                    src={e.cover_url}
