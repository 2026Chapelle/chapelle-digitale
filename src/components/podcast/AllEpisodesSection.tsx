          ...
          {filtered.map((ep) => {
            ...
            return (
              <button
                ...
                className="group card-cinematic p-3 flex items-center gap-3 text-left transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#D4AF37]"
