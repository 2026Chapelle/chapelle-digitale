...
export const PLATFORM_IMAGES: Record<PlatformeId, CieerImage> = {
  cier: {
    src: '/images/platformes/cier.webp',
  ...
  'chapelle-familiale': {
    src: '/images/platformes/chapelle-familiale.webp',
  ...
  jeunesse: {
    src: '/images/platformes/jeunesse.webp',
  ...
  'femmes-exceptions': {
    src: '/images/platformes/femmes-exceptions.webp',
  ...
  'cite-refuge': {
    src: '/images/platformes/cite-refuge.webp',
  ...
  cfic: {
    src: '/images/platformes/cfic.webp',
  ...
  mahanaim: {
    src: '/images/platformes/mahanaim.webp',
