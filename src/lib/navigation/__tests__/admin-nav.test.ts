...
const LEGACY_HREFS = [
  ...
  '/admin/enseignements', '/admin/teaching-series', '/admin/teaching-seasons', '/admin/teaching-comments', '/admin/formations', '/admin/modules', '/admin/parcours', '/admin/questions-formations',
